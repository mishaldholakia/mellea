...
### `extract_model_tool_requests` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/helpers/openai_compatible_helpers.py#L11" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `chat_completion_delta_merge` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/helpers/openai_compatible_helpers.py#L40" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `message_to_openai_message` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/helpers/openai_compatible_helpers.py#L120" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `messages_to_docs` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/helpers/openai_compatible_helpers.py#L152" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
