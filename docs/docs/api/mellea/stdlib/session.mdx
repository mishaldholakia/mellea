...
### `get_session` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L40" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `backend_name_to_class` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L54" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `start_session` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L80" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `MelleaSession` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L176" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `clone` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L224" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `reset` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L249" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `cleanup` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L253" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `act` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L260" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
act(self, action: Component[S]) -> ModelOutputThunk[S]
```

#### `act` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L273" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
act(self, action: Component[S]) -> SamplingResult[S]
```

#### `act` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L285" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L331" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
instruct(self, description: str) -> ModelOutputThunk[str]
```

#### `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L350" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
instruct(self, description: str) -> SamplingResult[str]
```

#### `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L368" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `chat` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L429" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `validate` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L456" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `query` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L478" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `transform` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L511" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L544" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
aact(self, action: Component[S]) -> ModelOutputThunk[S]
```

#### `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L557" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
aact(self, action: Component[S]) -> SamplingResult[S]
```

#### `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L569" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L615" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
ainstruct(self, description: str) -> ModelOutputThunk[str]
```

#### `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L634" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
ainstruct(self, description: str) -> SamplingResult[str]
```

#### `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L652" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `achat` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L713" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `avalidate` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L740" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `aquery` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L762" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `atransform` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L795" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `powerup` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L828" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `last_prompt` <sup><a href="https://github.com/generative-computing/mellea/blob/main/mellea/stdlib/session.py#L836" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
