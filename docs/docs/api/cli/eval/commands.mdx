...
### `eval_run` <sup><a href="https://github.com/generative-computing/mellea/blob/main/cli/eval/commands.py#L9" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
