...
### `alora_train` <sup><a href="https://github.com/generative-computing/mellea/blob/main/cli/alora/commands.py#L8" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `alora_upload` <sup><a href="https://github.com/generative-computing/mellea/blob/main/cli/alora/commands.py#L37" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
