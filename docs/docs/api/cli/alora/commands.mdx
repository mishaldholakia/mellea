...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `alora_train` <sup><a href="https://github.com/mishaldholakia/mellea/blob/main/cli/alora/commands.py#L8" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `alora_upload` <sup><a href="https://github.com/mishaldholakia/mellea/blob/main/cli/alora/commands.py#L37" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
