...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `run` <sup><a href="https://github.com/mishaldholakia/mellea/blob/main/cli/decompose/decompose.py#L23" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#4ADE8033]/20 text-[#15803D]">CLASS</span> `DecompVersion` <sup><a href="https://github.com/mishaldholakia/mellea/blob/main/cli/decompose/decompose.py#L14" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
